package com.example.deviceregistrationandtelemetrybackend;
...
public class HelloController {
    ...
    public String hello() {
        return "Hello, Spring Boot! Welcome to deviceregistrationandtelemetrybackend";
    }
    ...
    public String info() {
        return "Spring Boot Application: deviceregistrationandtelemetrybackend";
    }
} 